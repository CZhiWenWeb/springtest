package com.czw.ms.gateway.handler;
 ...
 */
@Slf4j
public class MsGatewayExceptionHandler extends DefaultErrorWebExceptionHandler {

    public MsGatewayExceptionHandler(ErrorAttributes errorAttributes, ResourceProperties resourceProperties,
