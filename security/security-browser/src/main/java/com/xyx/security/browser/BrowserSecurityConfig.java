package com.xyx.security.browser;

import com.xyx.security.browser.session.CustomExpiredSessionStrategy;
import com.xyx.security.core.authentication.mobile.SmsCaptchaAuthenticationSecurityConfig;
import com.xyx.security.core.authentication.mobile.SmsCaptchaFilter;
import com.xyx.security.core.properties.SecurityProperties;
import com.xyx.security.core.validate.code.CaptchaFilter;
...
/**
 * @Author: czw
 * @CreateTime: 2019-09-02 11:05
 * @UpdeteTime: 2019-09-02 11:05
 * @Description:自定义浏览器安全配置
 */
@Configuration
